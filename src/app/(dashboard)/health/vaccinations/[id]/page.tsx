...
function InfoRow({ label, value }: { label: string; value: React.ReactNode }) {
  return (
    <div className="flex gap-3 py-2.5 border-b border-[#F4F5F7] dark:border-[#262626] last:border-0">
      <span className="text-[11px] font-semibold text-[#9CA3AF] dark:text-[#A3A3A3] uppercase tracking-wide min-w-30 shrink-0 mt-0.5">{label}</span>
      ...
      <div className="grid grid-cols-3 gap-5">
        ...
        <div className="col-span-2 space-y-4">
          ...
          <div className="rounded-xl border border-blue-100 bg-[#EFF6FF] dark:bg-blue-500/15 px-5 py-5 flex items-center gap-4">
            ...
            <div>
              <p className="text-[18px] font-black text-[#1E3A5F] dark:text-[#93C5FD] uppercase tracking-wide">{vaccination.vaccine_name}</p>
              <div className="flex items-center gap-1.5 mt-1">
                <CalendarDays size={12} className="text-[#3B82F6] dark:text-[#60A5FA]" />
                <p className="text-[12px] font-semibold text-[#3B82F6] dark:text-[#60A5FA]">
          ...
          <div className="bg-white dark:bg-[#171717] rounded-xl border border-[#E9EAEC] dark:border-[#262626] p-5">
            <p className="text-[11px] font-black uppercase tracking-widest text-[#1F2937] dark:text-white mb-3">Vaccination Details</p>
          ...
          <div className="bg-white dark:bg-[#171717] rounded-xl border border-[#E9EAEC] dark:border-[#262626] overflow-hidden">
            ...
            <div className="p-4">
              <div className="flex flex-col items-center text-center mb-4 pt-1">
                ...
                <p className="text-[11px] text-[#9CA3AF] dark:text-[#A3A3A3] mt-0.5">{vaccination.resident.purok?.name ?? "—"}</p>
              </div>
