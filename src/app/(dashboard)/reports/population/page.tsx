...
const MOCK = {
  total: 1284,
  byPurok: [
    { purok: "Purok I",   count: 310, households: 78  },
    { purok: "Purok II",  count: 278, households: 66  },
    { purok: "Purok III", count: 342, households: 85  },
    { purok: "Purok IV",  count: 198, households: 50  },
    { purok: "Purok V",   count: 156, households: 39  },
  ],
  bySex: [
    { sex: "Male",   count: 628 },
    { sex: "Female", count: 656 },
  ],
  byAgeGroup: [
    { group: "0–4",    count: 98  },
    { group: "5–12",   count: 145 },
    { group: "13–17",  count: 112 },
    { group: "18–30",  count: 223 },
    { group: "31–59",  count: 550 },
    { group: "60+",    count: 156 },
  ],
  byCivilStatus: [
    { status: "Single",    count: 445 },
    { status: "Married",   count: 712 },
    { status: "Widowed",   count: 89  },
    { status: "Separated", count: 32  },
    { status: "Live-in",   count: 6   },
  ],
  byEmployment: [
    { status: "Employed",      count: 487 },
    { status: "Unemployed",    count: 213 },
    { status: "Self-employed", count: 156 },
    { status: "Student",       count: 257 },
    { status: "Retired",       count: 89  },
    { status: "OFW",           count: 82  },
  ],
};
...
export default function PopulationReportPage() {
  ...
  useEffect(() => {
    fetch(`/api/reports?type=population`)
