...
const SEX_COLORS   = ["#3E5C76", "#6D4AFF"];
    ...
    <div>
      ...
      {loading || !data ? (
        ...
        <>
          ...
          >
            <StatCard label="Total Registered Residents" value={data.total.toLocaleString()} icon={Users} color="blue" />
            {data.bySex.map((s, i) => (
              <StatCard
                key={s.sex}
                label={s.sex}
            ...
            <ChartCard title="Population by Purok">
              <ResponsiveContainer width="100%" height={200}>
                <BarChart data={data.byPurok} barSize={30}>
                  ...
                  <Bar dataKey="count" fill="#3E5C76" radius={[6, 6, 0, 0]} />
                </BarChart>
              </ResponsiveContainer>
