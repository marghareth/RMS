          ...
          <table className="w-full text-left">
            <thead>
              <tr className="border-b border-[#E9EAEC] bg-[#F9FAFB]">
                <th className="px-4 py-3 text-[10px] font-bold uppercase tracking-wide text-[#6B7280]">Deceased Name</th>
                <th className="px-4 py-3 text-[10px] font-bold uppercase tracking-wide text-[#6B7280]">Date of Death</th>
                <th className="px-4 py-3 text-[10px] font-bold uppercase tracking-wide text-[#6B7280]">Immediate Cause</th>
                <th className="px-4 py-3 text-[10px] font-bold uppercase tracking-wide text-[#6B7280]">Underlying Cause</th>
            ...
            <tbody>
              {records.map((r) => (
                ...
                >
                  ...
                  <td className="px-4 py-3 text-[12px] text-[#374151]">{formatDate(r.date_of_death)}</td>
                  <td className="px-4 py-3 text-[12px] text-[#374151]">{r.immediate_cause}</td>
                  <td className="px-4 py-3 text-[12px] text-[#6B7280]">{r.underlying_cause || "—"}</td>
                  <td className="px-4 py-3 text-[12px] text-[#6B7280]">{formatDate(r.created_at)}</td>
