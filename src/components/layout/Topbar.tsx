...
export default function Topbar({
  ...
  return (
    <header className={`flex h-15 shrink-0 items-center gap-4 border-b border-[#E9EAEC] bg-white px-5 dark:border-[#262626] dark:bg-[#111111] sm:px-6 ${className}`}>
      <button
        type="button"
        onClick={onMenuClick}
      ...
      <div className="flex min-w-0 flex-1 items-center">
        <div className="relative w-full max-w-md">
          ...
          <input
            ...
            placeholder="Search..."
            className="h-10 w-full rounded-lg border border-[#E9EAEC] bg-[#F4F5F7] pl-10 pr-4 text-[13px] text-[#1F2937] transition placeholder:text-[#9CA3AF] focus:border-[#3B82F6] focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#3B82F6]/15 dark:border-[#262626] dark:bg-[#171717] dark:text-white dark:focus:bg-[#171717]"
          />
        </div>
      </div>
      ...
      <div className="ml-auto flex shrink-0 items-center gap-2">
        ...
        <div ref={notifRef} className="relative">
          <button
            ...
            className="relative flex h-9 w-9 items-center justify-center rounded-lg text-[#6B7280] transition-colors hover:bg-[#F4F5F7] hover:text-[#1F2937] dark:hover:bg-[#1F1F1F] dark:hover:text-white"
          >
            <Bell size={18} />
          ...
          {notifOpen && (
            <div className="absolute right-0 top-full z-30 mt-2 w-80 overflow-hidden rounded-lg border border-[#E9EAEC] bg-white shadow-lg dark:border-[#262626] dark:bg-[#171717]">
              <div className="border-b border-[#F4F5F7] px-4 py-3 dark:border-[#262626]">
                <p className="text-[13px] font-semibold text-[#1F2937] dark:text-white">Notifications</p>
                  ...
                  notifications.map((n) => {
                    ...
                    return (
                      <button
                        ...
                        className="flex w-full items-start gap-2.5 border-b border-[#F4F5F7] px-4 py-3 text-left transition last:border-0 hover:bg-[#F9FAFB] dark:border-[#262626] dark:hover:bg-[#1F1F1F]"
                      >
                        <Icon size={15} className={`mt-0.5 shrink-0 ${style.iconColor}`} />
                        <div className="min-w-0">
                          <p className="text-[12px] font-semibold text-[#1F2937] dark:text-white">{n.title}</p>
        ...
        <div ref={menuRef} className="relative">
          <button
            ...
            className="flex items-center gap-2.5 rounded-lg px-1.5 py-1 transition-colors hover:bg-[#F4F5F7] dark:hover:bg-[#1F1F1F]"
          >
            <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-[#1F2937] text-[11px] font-bold text-white dark:bg-[#3B82F6]">
              {initial}
            </div>
            <div className="hidden text-left sm:block">
              <p className="text-[13px] font-semibold leading-tight text-[#1F2937] dark:text-white">
                {username}
              </p>
          ...
          {menuOpen && (
            <div className="absolute right-0 top-full z-30 mt-2 w-56 overflow-hidden rounded-lg border border-[#E9EAEC] bg-white shadow-lg dark:border-[#262626] dark:bg-[#171717]">
              <div className="border-b border-[#F4F5F7] px-4 py-3 dark:border-[#262626]">
              ...
              <button
                ...
                className="flex w-full items-center gap-2.5 px-4 py-2.5 text-left text-[13px] font-medium text-red-600 transition hover:bg-red-50 dark:hover:bg-red-950/40"
              >
                <LogOut size={15} />
                Log out
              </button>
