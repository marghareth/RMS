          ...
          <div className="flex h-full flex-col">
            <SheetHeader>
              <div className="flex min-w-0 items-center gap-3">
                <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-[#EBF3FF] text-[13px] font-black text-[#1D4ED8]">
                  {original.resident.fname[0]}
                  {original.resident.lname[0]}
                </div>
                <div className="min-w-0">
                  <SheetTitle>Edit Official</SheetTitle>
                  <p className="mt-0.5 truncate text-[12px] text-[#9CA3AF]">{residentFullName(original.resident)}</p>
                </div>
              </div>
            ...
            <SheetBody className="space-y-4">
              {/* Resident (read-only) */}
              <div className="flex items-center gap-3 rounded-xl border border-[#E9EAEC] bg-[#F9FAFB] px-4 py-3">
