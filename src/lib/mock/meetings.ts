...
export const MOCK_MEETINGS: MeetingRecordMock[] = [
  {
    ...
    title: "Q2 Budget Review & CCTV Resolution",
    location: "Barangay Hall Session Room",
    status: "COMPLETED",
    recorded_by: 3,
    recorder: SECRETARY,
  ...
  },
  {
    ...
    title: "Mid-Year Accomplishment Report",
  ...
  },
  {
    ...
    title: "Blotter Policy & Business Permits",
    location: "Barangay Hall Session Room",
    status: "COMPLETED",
    recorded_by: 1,
    recorder: CAPTAIN,
  ...
  },
  {
    ...
    title: "Annual Report & Purok Leader Election",
    location: "Barangay Covered Court",
    status: "COMPLETED",
    recorded_by: 3,
    recorder: SECRETARY,
